module.exports = function( grunt ) {
  ...
  grunt.registerTask( 'js', [ 'concat:js', /*'jshint:devTemplate', 'jshint:devComponents',*/ 'concat:pluginsJS', 'copy:devComponents', /*'uglify:devTemplate', 'uglify:devComponents',*/ 'clean:js' ] );
