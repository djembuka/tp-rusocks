(function ($) {
  ...
  $(function () {
    ...
    document
      .querySelector('.b-catalog-detail__icons .b-icon-zoom')
    ...
    document
      ...
      .addEventListener('click', function (e) {
        var item = e.target.classList.contains('b-catalog-detail__gallery-item')
          ? e.target
    ...
    $('.b-catalog-detail__icons .b-icon-zoom').click(function (e) {
      e.preventDefault();
      createBigGallery();
    });
